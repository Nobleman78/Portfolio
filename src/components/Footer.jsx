      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col md:flex-row justify-between items-start gap-12">
          ...
          <div className="grid grid-cols-2 gap-12 sm:grid-cols-3">
            ...
            <div>
              ...
              <div className="space-y-3">
                {[
                  { name: 'LinkedIn', url: 'https://www.linkedin.com/in/jesmin-chakma-a92250246/' },
                  { name: 'GitHub', url: 'https://github.com/Nobleman78' },
                  {
                    name: 'Email',
                    url: 'mailto:jesminchakma39@gmail.com', 
                    target:'_self'
                  },
                ].map((item) => (
                  <a
        ...
        <div className="mt-16 pt-8 border-t border-gray-200 dark:border-gray-800 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-base text-gray-500 dark:text-gray-400">
            &copy; {new Date().getFullYear()} Jesmin Chakma. All rights reserved.
          </p>
