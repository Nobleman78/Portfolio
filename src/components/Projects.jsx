export default function Projects() {
    const projects = [
        ...
        },
        {
            ...
            tags: ["React", "Firebase", "Context API", "Stripe", "Tailwind CSS"],
        ...
        },
        {
            ...
            tags: ["React", "Spotify API", "Tailwind CSS", "Axios", "Context API"],
                            ...
                            <div className="p-6">
                                ...
                                <div className="flex flex-col sm:flex-row gap-2">
                                    <a 
                                        ...
                                        className="inline-flex items-center justify-center gap-2 px-3 py-2 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded-lg text-sm font-medium transition-all duration-300 shadow hover:shadow-md"
                                    >
                                    ...
                                    <a 
                                        href={project.github} 
                                        className="inline-flex items-center justify-center gap-2 px-3 py-2 border border-blue-500 text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-gray-700 rounded-lg text-sm font-medium transition-all duration-300 shadow-sm hover:shadow-md"
                                    >
